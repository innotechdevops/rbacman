...
// FindById
// @Tags user_role
// @Summary Find a user_role by id
// @Accept json
// @Produce json
// @Param query body QueryOne true "query"
// @Success 200 {object} core.Success{data=UserRole}
// @Failure 400 {object} core.Error
// @Failure 404 {object} core.Error
// @Security JWTAuth
// @Router /v1/user-role/one [post]
...
// FindList
// @Tags user_role
// @Summary Find a list of user_role
// @Accept json
// @Produce json
// @Param query body QueryMany true "query"
// @Success 200 {object} core.Success{data=core.Paging{list=[]UserRole}}
// @Failure 400 {object} core.Error
// @Security JWTAuth
// @Router /v1/user-role/many [post]
...
// Create
// @Tags user_role
// @Summary Create a user_role
// @Accept json
// @Produce json
// @Param user_role body CreateUserRole true "user_role"
// @Success 201 {object} core.Success{data=UserRole}
// @Failure 400 {object} core.Error
// @Security JWTAuth
// @Router /v1/user-role/create [post]
...
// @Accept json
// @Produce json
// @Param user_role body UpdateUserRole true "user_role"
// @Success 200 {object} core.Success{data=UserRole}
// @Failure 400 {object} core.Error
// @Failure 404 {object} core.Error
// @Security JWTAuth
// @Router /v1/user-role/update [post]
...
// Delete
// @Tags user_role
// @Summary Delete a user_role by id
// @Accept json
// @Produce json
// @Param user_role body DeleteUserRole true "user_role"
// @Success 200 {object} core.Success
// @Failure 400 {object} core.Error
// @Failure 404 {object} core.Error
// @Security JWTAuth
// @Router /v1/user-role/delete [post]
