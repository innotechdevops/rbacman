...
func (r *repository) FindList(params Params) []Organization {
	return r.Ds.FindList(params)
}

func (r *repository) FindById(id int64) Organization {
	return r.Ds.FindById(id)
}

func (r *repository) Create(data *CreateOrganization) error {
	return r.Ds.Create(data)
}

func (r *repository) Update(data *UpdateOrganization) error {
